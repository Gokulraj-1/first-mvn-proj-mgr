...
public class TestValidationUtil {
	...
	/**
	 * It will pass a positive number to validateAge method and print if the test
	 * case has passed else it will print test case failed
	 */
	...
	/**
	 * It will pass a -ve number to validateAge method and print the test case has
	 * passed if an exception is thrown else it will print test case failed
	 */
